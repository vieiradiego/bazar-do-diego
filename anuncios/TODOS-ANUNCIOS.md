# Todos os anúncios do Bazar do Diego
...
**Preço:** R$ 2.762 · 18% abaixo do novo
...
Galaxy Tab S9 FE Plus com 128GB de armazenamento, Wi-Fi. Acompanha a S Pen original e capa com suporte. Tela grande, ótima para leitura, estudo e streaming. Bateria em bom estado e tela sem detalhes. Em estado de uso, sem detalhes.

Novo custa cerca de R$ 3.385 em Amazon. Aqui sai por R$ 2.762, 18% abaixo.
...
# Placa-Mãe ASRock X370 Taichi AM4 com Wi-Fi, SLI e CrossFire
...
Novo custa cerca de R$ 831,99 em KaBuM (RM850e). Aqui sai por R$ 644, 23% abaixo.
...
## Descrição para o Marketplace
Gabinete Cooler Master HAF XB EVO (RC-902XB), o cubo horizontal que também funciona como bancada de testes. Suporta placas ATX, tem duas alças de transporte, gaveta de placa-mãe removível (você monta a máquina na mesa e depois encaixa), duas baias hot-swap de 3.5 polegadas na frente e espaço para radiador de 240mm no topo. Aceita placa de vídeo longa: a GTX 1080 Ti que está aqui no bazar entra sem apertar. Modelo descontinuado e muito procurado por quem monta PC de LAN ou bancada. Vai completo, com as duas alças, o painel frontal e os parafusos, e ACOMPANHA A CAIXA ORIGINAL, o que ajuda muito se você precisar transportar ou revender depois. Em estado de uso, sem detalhes.
...
**Preço:** R$ 593 (cada) · 45% abaixo do novo
**Categoria:** PC e Hardware
...
## Descrição para o Marketplace
Memória Corsair Vengeance LPX DDR4 de 16GB, 2400MHz, CL14 (14-16-16-31), 1.20V, part number CMK16GX4M1A2400C14. Dissipador de alumínio em perfil baixo, compatível com qualquer cooler. São duas unidades idênticas, do mesmo lote: levando as duas você fecha 32GB em dual channel. Testadas e funcionando, sem erro de memória. Preço por pente. Em estado de uso, sem detalhes.

Novo custa cerca de R$ 1.079,90 em KaBuM. Aqui sai por R$ 593, 45% abaixo.
...
## Descrição para o Marketplace
Rack aparador em madeira maciça com acabamento nogueira, sobre rodízios industriais. Tem duas gavetas com puxadores metálicos tipo alça, dois nichos abertos com prateleira e um vão inferior. O tampo é de vidro sobre uma colagem de quadrinhos feita à mão, uma peça única, não existe outra igual. Serve de rack de TV, aparador de entrada ou bancada de apoio. Em estado de uso, sem detalhes.
...
# Processador AMD Ryzen 7 1800X AM4 de 8 núcleos e 16 threads
...
## Descrição para o Marketplace
Processador AMD Ryzen 7 1800X: 8 núcleos e 16 threads, 3.6 GHz de base e 4.0 GHz de turbo, socket AM4, 16MB de cache L3, multiplicador destravado para overclock. Foi o carro-chefe da AMD no lançamento do Ryzen e continua muito capaz para edição de vídeo, compilação, virtualização e streaming, tarefas que se beneficiam de muitos threads. Não acompanha cooler, porque o 1800X sempre foi vendido sem. Funcionando perfeitamente, sem pino torto. Fecha o kit com a X370 Taichi que também está no bazar. Em estado de uso, sem detalhes.
...
## Descrição para o Marketplace
Armário baixo em madeira pintada de azul turquesa com pátina envelhecida, cerca de 1 metro de largura, sobre rodízios. De um lado, porta com vidro e prateleira interna; do outro, três prateleiras abertas. Estilo provençal, em que a pátina é justamente o charme da peça. Bom para sala, cozinha ou como aparador de louças. Em estado de uso, sem detalhes.
...
## Descrição para o Marketplace
Mouse gamer Logitech G903 LIGHTSPEED, sem fio, com sensor de alta precisão, botões laterais configuráveis e formato ambidestro, já que dá para trocar os botões de lado. A conexão LIGHTSPEED da Logitech tem latência de mouse com fio, a mesma tecnologia da linha PRO usada em campeonato. Recarregável, e compatível com o mouse pad de carga POWERPLAY, que não acompanha. Acompanha a CAIXA ORIGINAL, o cabo trançado de recarga, o adaptador extensor USB e os painéis laterais magnéticos que trocam a configuração dos botões, que é o que deixa o mouse ambidestro. Modelo conferido na etiqueta da base: G903 LIGHTSPEED, P/N 810-006667, legível na foto. Funcionando, sem clique duplo. Em estado de uso, sem detalhes.

Novo custa cerca de R$ 861,71 em KaBuM. Aqui sai por R$ 399, 54% abaixo.
...
## Descrição para o Marketplace
Water cooler all-in-one Cooler Master MasterLiquid 240, radiador de 240mm com bomba de dupla câmara e perfil baixo. Acompanha a caixa original, o espumado interno e os suportes de instalação. Refrigeração líquida fechada, sem manutenção. As duas ventoinhas do radiador vão à parte: o kit Corsair SP140 que também está no bazar encaixa direto. Em estado de uso, sem detalhes.
...
## Descrição para o Marketplace
HD Seagate Desktop de 3TB, modelo ST3000DM003, SATA 3.5 polegadas. Bastante espaço por pouco dinheiro, bom para armazenamento em massa, backup e biblioteca de mídia. Rodo o teste SMART e mando o print antes da compra, para você conferir a saúde do disco antes de fechar. Em estado de uso, sem detalhes.
...
Novo custa cerca de R$ 639,99 em KaBuM. Aqui sai por R$ 375, 41% abaixo.
...
# Poltrona de pallet com rodízios e estofado pop art
...
## Descrição para o Marketplace
Poltrona de um lugar feita sobre pallet de madeira maciça envernizada, montada em quatro rodízios, então dá para mudar de canto sem esforço. Almofadas soltas de assento e encosto em tecido colorido com estampa pop art. São duas unidades iguais, ótimas para varanda, home office ou canto de leitura. Preço por unidade; levando as duas, faço preço melhor. Em estado de uso, sem detalhes.

Novo custa cerca de R$ 460 em Pallet SP. Aqui sai por R$ 350, 24% abaixo.
...
## Descrição para o Marketplace
HD Western Digital Purple de 2TB, modelo WD20PURX, SATA com 64MB de cache. A linha Purple é feita para gravação 24/7 em DVR e NVR de câmeras, então é um disco projetado para trabalhar sem parar. Fabricado em 2015. Rodo o teste SMART e mando o print antes da compra, com horas ligadas e setores realocados, para você comprar sabendo exatamente o que está levando. Em estado de uso, sem detalhes.

Novo custa cerca de R$ 582 em Net Computadores (WD22PURZ). Aqui sai por R$ 296, 49% abaixo.
...
Novo custa cerca de R$ 369 em Apple Brasil. Aqui sai por R$ 256, 31% abaixo.
...
# Cadeira Pingo com assento gota e pés de madeira

**Preço:** R$ 246 (cada) · 17% abaixo do novo
**Categoria:** Casa
...
## Descrição para o Marketplace
Cadeira design Pingo com assento em polipropileno no formato gota e pés de madeira maciça com estrutura metálica cruzada. Suporta até 120kg. Disponíveis 2 turquesa e 2 vermelhas. Sem rachaduras ou manchas. Preço por unidade.

Novo custa cerca de R$ 295,65 em Móveis do Limar. Aqui sai por R$ 246, 17% abaixo.
...
Novo custa cerca de R$ 649 em Bazar Militar. Aqui sai por R$ 188, 71% abaixo.
...
Novo custa cerca de R$ 189 em Rei dos Parafusos. Aqui sai por R$ 164, 13% abaixo.
...
# Bolsa Trader Joe's de lona importada
...
Novo custa cerca de R$ 99 em CopShop Brasil. Aqui sai por R$ 69, 30% abaixo.
...
# Suporte de Mesa ECOODA para Tablet em alumínio com base giratória 360°
...
## Descrição para o Marketplace
Suporte de mesa para tablet da ECOODA, em alumínio maciço. A base é quadrada e pesada, com disco giratório de 360°, então dá para virar a tela para quem está do outro lado da mesa sem levantar o aparelho. O braço é articulado em duas juntas e dobra por completo, deixando o suporte plano para guardar ou viajar. A altura e o ângulo de inclinação são ajustáveis, e o apoio é forrado para não riscar. Serve para tablet e iPad de qualquer tamanho até uns 13 polegadas, e também para celular e leitor. Nas fotos ele aparece com um Galaxy Tab S9 FE+ de 12,4 polegadas encaixado, que é justamente o tablet que também está à venda aqui no bazar. Em estado de uso, sem detalhes.
...
Novo custa cerca de R$ 99,90 em KaBuM. Aqui sai por R$ 48, 52% abaixo.
...
**Preço:** R$ 34 (cada) · 10% abaixo do novo
**Categoria:** Acessórios
...
## Descrição para o Marketplace
Aromatizante Little Trees original importado, pack com 3 unidades lacrado. Disponíveis: 2 packs Black Ice, 1 Supernova e 1 Caribbean Colada. Preço por pack.

Novo custa cerca de R$ 37,90 em Mercado Livre. Aqui sai por R$ 34, 10% abaixo.
